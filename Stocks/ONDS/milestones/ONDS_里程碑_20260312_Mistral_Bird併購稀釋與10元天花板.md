# ONDS 里程碑：Mistral / Bird 併購稀釋與 `$10` 天花板
...
- **補充來源**：2026-03-09 Substack Note `大叔美股筆記-20260309-ondas-prelim-results-mistral-tier1-71a8ac32`（初步財報 / Mistral 8-K 重要性短評）；2026-03-09 Substack 付費文章 `大叔美股筆記-20260309-onds-pentagon-prime-mistral-stock-deal-37def283`（Mistral 全股票收購 / Reg D / escrow / defense prime thesis）；2026-03-11 Substack Note `大叔美股筆記-20260311-ondas-bird-acquisition-resale-risk-b23af1db`（Bird acquisition / 6,933,110 股 resale registration / second-payment overhang 補核）；Ondas 2026-03-11 424B7（Bird `$5.17M` cash、6,933,110 股、約 `$37.879M` Additional Stock Consideration 與 volume limitation）
- **KOL 原文整理**：`KOL/大叔美股筆記/articles/20260312_onds_ma_dilution_mistral_bird_uncle.md`
- **交會等級**：L4
- **主題 tags**：#國防科技 #併購 #稀釋風險 #ReRating #估值風險 #訂單合約
- **催化劑 / 風險**：催化劑是 Mistral / Bird revenue contribution、Mistral IDIQ / DoD contract vehicles 轉 task order、2026 revenue guidance 上修；風險是 Bird resale overhang、M&A share dilution、IDIQ 被誤讀為 guaranteed revenue、fully diluted shares 持續擴張。

## 一句話結論

大叔把 Mistral / Bird 併購視為 **ONDS** 從 OAS platform story 走向 defense prime / public safety contract channel 的重大推進，但同時用約 5.1% 直接稀釋、Bird resale overhang 與 `$10` 估值天花板提醒市場：這筆併購必須靠 2026 revenue step-up 和 Q2 order conversion 來「解毒」。

## 大叔核心判斷

| 主題 | 內容 | 判讀 |
|---|---|---|
| 併購性質 | Mistral + Bird 是「以紙換肉」，用股本換 defense prime access、contract vehicles、public safety / aircraft protection 能力 | 正面但有短線稀釋代價 |
| 直接稀釋 | 大叔估算 Mistral 約 `1,225 萬股`、Bird 約 `1,072 萬股`，合計約 `2,297 萬股`，股本從約 `4.5 億股` 到 `4.73 億股` | 約 `5.1%` 直接稀釋 |
| 市場天花板 | 2026 年 1 月 `$1B` 融資已放大股本，Mistral / Bird 再登記轉售會讓市場在 `$10` 附近先打折 | 短線壓力不是 thesis 否定，但需要時間消化 |
| 長線解毒 | Mistral 的美軍 / state-local public safety contract channel 若在 Q2 轉 task order，能抵消股本稀釋 | 關鍵在 revenue / backlog / cash conversion |
...
| 來源 | 價位 / 數字 | 性質 | 追蹤方式 |
|---|---:|---|---|
| 大叔 P/S 模型保守情境 | `$7.77` | 15x P/S、`$245M` 2026 revenue、4.73 億股 | 情境估值，不是目標價 |
| 大叔 P/S 模型中性情境 | `$10.35` | 20x P/S，近似當時 `$10` 附近交易區 | 用來解釋天花板 |
| 大叔 P/S 模型偏多情境 | `$13.00` | 25x P/S，需 HERO 120 / Mistral 轉單順利 | 需用 Q2 / Q3 bookings 與 revenue 驗證 |

## 後續追蹤

| 日期 / 區間 | 事件 | 相關 ticker | 影響方向 | 觀察指標 |
|---|---|---|---|---|
| 2026-03-18（原文語境） | Bird 第二付款 / Additional Stock Consideration | **ONDS** | 負面若形成集中賣壓；中性若以現金或平穩限量消化 | 424B7 已補核約 `$37.879M` additional consideration 與 volume-limitation 機制；後續仍追 actual cash / stock mix、shares outstanding、volume、selling stockholder activity |
| 2026-03-23（整理日後續） | revenue guidance 是否高於 `$250M` | **ONDS** | 已正面校準 | FY2025 release target 至少 `$375M`；後續追 quarterly revenue |
| 2026Q2 | Mistral order conversion | **ONDS** | 正面若有 task order / revenue | HERO 120 / LUS、C-UAS localization、state / local public safety awards |
| 2026Q2-Q3 | P/S 模型回頭檢查 | **ONDS** | 未定 | 2026 revenue run-rate、gross margin、fully diluted shares、cash burn |
