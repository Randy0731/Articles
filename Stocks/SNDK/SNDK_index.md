...
此檔記錄 **SNDK** / SanDisk 在本專案中的正式追蹤來源。KOL 文章完整語境仍放在 `KOL/`；本目錄只保留個股 thesis、季度追蹤、風險與後續檢查點。
...
正式建立 `Stocks/SNDK/` 前回查 `SNDK|SanDisk|Sandisk|WDC`。本次補入 **SNDK** L2+ 前史：

| 日期 | KOL / 來源 | 既有語境 | 判定 / 處理 |
|---|---|---|---|
| 2026-02-28 | KP / FOMOSoc | SanDisk / SK Hynix HBF：HBM 與 SSD 之間的新 memory hierarchy 層，承接 model weights / KV cache | L2-L3 前史，補入 `SNDK_筆記_2026Q1.md` |
| 2026-04-28 | 大叔美股筆記 / Melius Research | Melius 將 **SNDK** 放入 AI data demand / NAND re-rating；`1350` 是分析師目標價，不是大叔自身 target | L2 前史，補入 `SNDK_筆記_2026Q2.md` |
| 2026-04-30 | 大叔美股筆記 / SemiAnalysis | Samsung union / potential strike 對 NAND / memory supply-tightness 的 read-through | L2 前史，補入 `SNDK_筆記_2026Q2.md` |
| 2026-04-18 | 宋分 / 讀者提問 | 讀者提問中的 **SNDK** 只作大盤反彈 / 節奏脈絡 | L1，不補入 `Stocks/SNDK/` |
| 2026-04-28 | 大叔美股筆記 / BofA WDC | **WDC** nearline HDD / storage chain 主文，**SNDK** 只作相鄰 storage / NAND 邊界 | L1，不補入 `Stocks/SNDK/` |
