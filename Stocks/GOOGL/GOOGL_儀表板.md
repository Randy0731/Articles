...
- **本次補入的 KP 2025Q4 技術 / Cloud 選擇權**：KP 2025-10-25 將 Google Willow / Quantum Echoes 解讀為可驗證量子路線圖，不是短期商用；同篇 Anthropic 最高約 100 萬顆 TPU 合作，補強 Google TPU / Cloud 在 AI 推理 workload 的商業背書。KP 2025-11-01 再補 Google Cloud revenue +`34%`、operating profit 約 `$2.8B`、backlog 約 `$155B`、Meta 約 `$10B` AI compute deal 與 Anthropic 數百萬 TPU 部署，將 Google Cloud 從追趕者提升為高利潤 AI 雲端挑戰者。
...
- **本次補入的 KP 2026-02-21 Google / Ormat 地熱補強**：KP 將 Google / Ormat up to 150MW geothermal deal 解讀為 AI data center 從年度綠電採購走向 24/7 clean baseload 的訊號。Clean Transition Tariff 讓 Google 自付 clean power premium，NV Energy 協調 PPA / grid / balancing，PUCN 監管保護一般居民；這和 Intersect Power、百年債、Apollo OCS 一起補強 Alphabet AI infrastructure utility thesis。
- **本次補入的 KP 2026-02-28 TPU 外部化補強**：KP 認為 Google 正用 FluidStack investment / lease guarantee、Meta TPU lease 與 neocloud 通路，把 TPU 從 Google Cloud 內部成本中心推向外部利潤中心。這補強 TorchTPU / OCS / AI data center energy thesis，但需追 CUDA inertia、CoWoS allocation、external TPU supply、neocloud leverage 與 Cloud AI revenue / margin。
...
- **本次補入的 KP 2026-04-25 TPU 8 補強**：KP 將 Google TPU 8 解讀為 system-level moat，而不是單顆晶片升級。8t Sunfish 偏 training，8i Zebrafish 偏 inference / agents；HBM、SRAM、MPU 與 Broadcom / MediaTek / Marvell / Intel 分工，讓 Google 從 chip designer 升級為 AI factory system definer。對 **GOOGL** 是 L3 Cloud AI TCO / cost per token / TPU monetization 補強，但仍需用 Cloud AI revenue、margin、external TPU adoption 與 workload split 驗證。
...
| KP Google Cloud Q3 anchor | Google Cloud revenue +`34%`、operating profit 約 `$2.8B`、backlog 約 `$155B`，Meta 約 `$10B` AI compute deal、Anthropic 數百萬 TPU deployment | KP / FOMOSoc 2025-11-01 | 歷史 L2：補強 Google Cloud 從追趕者轉為 AI 雲端挑戰者，但需追 revenue conversion / margin |
| KP Ironwood TPU anchor | Ironwood 單晶片 `4.6 PetaFLOPS`，`9,216` chips Pod / `42.5 ExaFLOPS`，Anthropic `100萬顆` Ironwood TPU 多年期訂單 | KP / FOMOSoc 2025-11-08 | 歷史 L3：補強 Google 在 inference / cost per token / full-stack TPU 的差異化，但仍受 Google Cloud 圍牆花園限制 |
| KP Gemini-Siri AIaaS anchor | Apple 每年約 `$1B` 授權 Gemini 作 Siri 核心智能，模型約 `1.2萬億` 參數，Google 可觸及 `18億+` Apple active devices | KP / FOMOSoc 2025-11-08 | 歷史 L3：Gemini 從模型產品升級為可授權的 AI infrastructure service，需追 Siri launch / licensing revenue |
...
| KP Google / Ormat geothermal anchor | Google / Ormat long-term geothermal deal up to 150MW；Clean Transition Tariff 由 Google 支付 premium，NV Energy 協調，PUCN 監管保護 ratepayer | KP / FOMOSoc 2026-02-21 | 歷史 L3：補強 24/7 clean baseload 與 AI data center power procurement；需追 CTT approval、MW delivery、capacity factor、power cost 與 Cloud AI capacity |
| KP TPU externalization anchor | Google / FluidStack investment KP 口徑約 `$100M`、FluidStack valuation 約 `$7.5B`、lease guarantee example `$3.2B`；Meta multibillion TPU lease；2026 TPU shipments 310-360 萬片 | KP / FOMOSoc 2026-02-28 | 歷史 L3：補強 TPU outside the wall / external monetization thesis；需追 Meta TPU workload、TorchTPU production readiness、Cloud AI revenue、CoWoS allocation 與 neocloud financing |
| KP Google / Wiz security anchor | Wiz acquisition KP 口徑 `$32B` all-cash，retention bonus `$1B`；Wiz 提供 CNAPP / agentless / multicloud visibility | KP / FOMOSoc 2026-03-14 | L3：補強 Google Cloud security / enterprise trust layer；需追 deal close、Wiz neutrality、Mandiant / Chronicle integration、security revenue 與 CNAPP customer retention |
...
| KP Google TPU 8 system-definer anchor | TPU 8t Superpod 9,600 chips / 121 exaFLOPS / 2PB shared memory；TPU 8i 單晶片 288GB HBM、3x SRAM，pod HBM 49TB -> 331TB；Broadcom / MediaTek / Marvell / Intel 分工 | KP / FOMOSoc 2026-04-25 | L3：補強 Google 從 TPU chip designer 升級為 AI factory system definer；需追 Cloud AI revenue / margin、cost per token、Gemini latency、external TPU adoption 與供應鏈 split |
...
| 2026-02-21 | KP 思考筆記第30期：Google / Ormat 地熱與 Clean Transition Tariff | 已整理 / L3 | 補上 Google 用 up to 150MW geothermal 和 CTT 取得 24/7 clean baseload 的模板；與 Intersect Power / 百年債 / 大叔 capex energy moat thesis 同方向，但需追 project delivery、PUCN / NV Energy approval 與 Cloud AI revenue 吸收能力 | `Stocks/GOOGL/quarterly/GOOGL_筆記_2026Q1.md` |
| 2026-02-28 | KP 思考筆記第31期：Google TPU 外部化、FluidStack 與 Meta TPU lease | 已整理 / L3 | 補上 Google 用 neocloud financing / lease guarantee 把 TPU 推出 Google Cloud 圍牆的商業化路線；對 GOOGL 是 TPU monetization 與 Cloud AI relevance 的 L3 補強，但需追 CUDA / developer inertia 與供應規模 | `Stocks/GOOGL/quarterly/GOOGL_筆記_2026Q1.md` |
...
| 問題 | 為何重要 | 後續檢查 |
|---|---|---|
| 2026 capex 是否真的落在 `$175B-$185B` 區間？ | 決定 FCF、depreciation 與市場對資本紀律的評價 | 每季 capex、data center delivery、guidance revision |
| Google Cloud / AI 是否能吸收新增折舊？ | 若 revenue / margin 跑不過折舊，AI 基建會拖累 ROIC | Cloud revenue、operating margin、AI backlog、TPU utilization |
| AI Search 是否能改寫廣告模型而非 cannibalize paid clicks？ | Search 仍是現金流底座，AI answer / agent action 可能改變 monetization | Search & other revenue、paid clicks、AI ad load、conversion attribution |
...
| Google capex 從 `$165B` 上修至 `$185B` 是 demand visibility 變強，還是成本 / component pricing 上升？ | Bytc 2026-04-29 記錄 Google 是四巨頭 capex 上修的主要增量之一；需用 official guidance、Cloud AI revenue、depreciation 和 FCF 驗證 | Alphabet 10-Q / transcript、capex guide、Google Cloud revenue / margin、PPE purchases、depreciation、FCF、power / component cost |
...
| Google Cloud 的高增長 / 高利潤是否能延續？ | KP 2025-11-01 將 Cloud +34%、operating profit `$2.8B` 與 backlog `$155B` 視為逆襲證據；若 capex / depreciation 吃掉 margin，歷史 L2 就不能外推 | Cloud revenue、operating margin、backlog conversion、Meta / Anthropic workload、TPU utilization、capex / depreciation |
...
| Google / Ormat geothermal 與 CTT 是否能形成可複製 clean baseload 模板？ | KP 2026-02-21 認為 AI data center 用電正在走向 24/7 clean baseload；若 CTT 成功，Google 可用自付 premium 換 capacity speed 與社會許可 | PUCN / NV Energy filings、CTT approval、Ormat MW delivery、capacity factor、power cost、data center uptime / Cloud AI capacity |
| Google TPU 外部化是否能轉成外部 Cloud AI revenue？ | KP 2026-02-28 認為 FluidStack / Meta TPU lease 是 TPU 從內部工具轉向利潤中心的訊號；若只是 lease guarantee 或低毛利 capacity，re-rate 力度有限 | FluidStack financing、Meta TPU lease / purchase、TorchTPU production readiness、TPU utilization、Cloud AI revenue、CoWoS allocation、developer adoption |
| Google / Wiz 是否能轉成 Google Cloud security moat？ | KP 2026-03-14 認為 Wiz 補上 Google Cloud 缺少的事前 CNAPP / multicloud security layer；若 Google 維持 Wiz neutrality，可能提升 enterprise trust，若破壞 neutrality 則可能流失客戶 | deal close、Wiz standalone brand、AWS / Azure support、Mandiant / Chronicle integration、CNAPP adoption、security revenue、customer churn |
...
| Google TPU 8 是否能把 system-definer 優勢轉成 Cloud AI revenue / margin？ | KP 2026-04-25 認為 TPU 8 的重點是 8t / 8i 分流、HBM / SRAM / MPU 與多供應商分工；投資含義需等 TPU 8 production、external adoption 與 Cloud AI economics 驗證 | TPU 8 deployment、Google Cloud AI revenue、Cloud margin、cost per token、Gemini latency、external TPU adoption、Broadcom / MediaTek / Marvell split |
...
| Ad Tech structural remedy / Google Ad Manager forced sale | 高 | 法院要求出售或拆分 Google Ad Manager / AdX，或限制 Google 同時控制買方、賣方與交易所 | KP 2025-09-06 |
...
| Geothermal / CTT delivery and regulatory risk | 中高 | Ormat geothermal project 延誤、CTT 未獲監管核准，或 Google clean baseload premium 未能轉成 Cloud AI capacity / revenue | KP 2026-02-21；整理者判斷 |
| TPU externalization / neocloud financing risk | 中高 | Google 外部 TPU demand 依賴 FluidStack / neocloud leverage、lease guarantees 或少數大客戶，若 delivery / utilization / margin 不佳，可能只是低毛利 capacity financing | KP 2026-02-28；整理者判斷 |
| Wiz multicloud neutrality / integration risk | 中高 | Google 收購後若弱化 Wiz 的 AWS / Azure support 或讓客戶擔心 lock-in，可能引發客戶轉向 Orca / Prisma / CrowdStrike / Zscaler；若整合 Mandiant / Chronicle 不順，也會降低 security moat | KP 2026-03-14；整理者判斷 |
...
| Berkshire signal 被過度外推 | 中 | Berkshire 倉位後續未加碼、只是小比例配置，或 Alphabet AI capex / antitrust 風險壓過 value-stock re-rating | KP 2025-11-15 |
...
| KP 2026-02-21 Google / Ormat geothermal | 中高 | 補上 clean baseload / CTT power procurement 模板；與 Intersect Power、百年債、大叔 capex / energy moat thesis 相互校準 | `Stocks/GOOGL/quarterly/GOOGL_筆記_2026Q1.md` |
| KP 2026-02-28 TPU externalization / FluidStack | 中高 | 補上 TPU outside the wall / neocloud financing / Meta TPU lease 的商業化路線；強化 Cloud AI monetization optionality，但需追供應規模、developer tooling 與 margin quality | `Stocks/GOOGL/quarterly/GOOGL_筆記_2026Q1.md` |
...
| KP 2026-04-25 Google TPU 8 | 中高 | 補上 Google TPU 8 / memory stack / supplier split 的 L3 系統級 moat：Google 以 8t / 8i 分流和 HBM / SRAM / MPU 控制 cost per token、latency 與供應鏈彈性，但仍需 Cloud AI revenue / margin 驗證 | `Stocks/GOOGL/quarterly/GOOGL_筆記_2026Q2.md` |
...
- `Stocks/GOOGL/quarterly/GOOGL_筆記_2026Q1.md`
- `Stocks/GOOGL/quarterly/GOOGL_筆記_2026Q2.md`
- `KOL/KP_FOMOSoc/weekly/KP_KP思考筆記第06期_Google反壟斷與晶片TCO.md`
- `KOL/KP_FOMOSoc/weekly/KP_KP思考筆記第16期_MetaWaymoCoreWeave_AMD與Google.md`
- `KOL/KP_FOMOSoc/weekly/KP_KP思考筆記第15期_GoogleTPU_Siri_GLP1與AI眼鏡.md`
